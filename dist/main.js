...
const miBiblioteca = new Biblioteca("Central de Quique");
const bibliotecaDeComics = new Biblioteca("Comics");
const bibliotecaSoloLibros = new Biblioteca("Biblioteca Literaria");
